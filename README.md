 ...
 ```
 - Example of input.json (reference mode):
 ```json
 {
     "ref_fasta": "ref.fasta",
     "ref_blastn": "./blastn/ref.self.tsv",
     "ref_gtf": "ref.gtf",
     "ref_write_pickle": "ref.pickle",
 ...
 ```
 - Example of input.json (contig and match mode):
 ```json
 {
     "ref_read_pickle": "./ref.pickle",
     "contig_fasta": "contig.fasta",
     "contig_blastn": "./blastn/contig.self.tsv",
     "contig_xprs_file": ["./kallisto/abundance.tsv",
                          "./rsem/rsem.isoforms.results",
                          "./salmon/quant.sf"],
